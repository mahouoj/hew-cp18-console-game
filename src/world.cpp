...
// collision
//bool world_test_collision(CollisionInfo* collision_info,
//    const BoundingBox* bbox, const Vec3 pos_prev, const Vec3 dir) {
//    int bounding_x_prev_min = floorf(pos_prev.x - bbox->width);
//    int bounding_x_prev_max = floorf(pos_prev.x + bbox->width);
//    int bounding_y_prev_min = floorf(pos_prev.y);
//    int bounding_y_prev_max = floorf(pos_prev.y + bbox->height);
//    int bounding_z_prev_min = floorf(pos_prev.z - bbox->depth);
//    int bounding_z_prev_max = floorf(pos_prev.z + bbox->depth);
//
//
//    Vec3 pos_new = vec3_add(pos_prev, dir);
//    bool test_x = false;
//    bool test_y = false;
//    bool test_z = false;
//    int bounding_x, bounding_y, bounding_z;
//
//    bool collision = false;
//    memset(collision_info, 0, sizeof(CollisionInfo));
//
//    if (dir.x < 0.0f) {
//        bounding_x = floorf(pos_new.x - bbox->width);
//        test_x = true;
//    }
//    else if (dir.x > 0.0f) {
//        bounding_x = floorf(pos_new.x + bbox->width);
...
//
//    if (dir.y < 0.0f) {
//        bounding_y = floorf(pos_new.y);
//        test_y = true;
//    }
//    else if (dir.y > 0.0f) {
//        bounding_y = floorf(pos_new.y + bbox->height);
//        test_y = true;
//    }
//
//    if (dir.z < 0.0f) {
//        bounding_z = floorf(pos_new.z - bbox->depth);
//        test_z = true;
//    }
//    else if (dir.z > 0.0f) {
//        bounding_z = floorf(pos_new.z + bbox->depth);
...
//
//    if (test_x) {
//        for (int y = bounding_y_prev_min; y <= bounding_y_prev_max; ++y) {
//            for (int z = bounding_z_prev_min; z <= bounding_z_prev_max; ++z) {
//                if (!world_if_block_passable(bounding_x, y, z)) {
//                    collision_info->x_collided = true;
//                    // TODO: break ? save ?
//                }
//            }
//        }
//    }
//    // TODO: bounce?
//    collision_info->pos_adjusted.x = collision_info->x_collided ? pos_prev.x : pos_new.x;
//
//    if (test_y) {
//        for (int x = bounding_x_prev_min; x <= bounding_x_prev_max; ++x) {
//            for (int z = bounding_z_prev_min; z <= bounding_z_prev_max; ++z) {
//                if (!world_if_block_passable(x, bounding_y, z)) {
//                    collision_info->y_collided = true;
//                    // TODO: break ? save ?
//                }
//            }
//        }
//    }
//    // TODO: bounce?
//    collision_info->pos_adjusted.y = collision_info->y_collided ? pos_prev.y : pos_new.y;
//
//    if (test_z) {
//        for (int y = bounding_y_prev_min; y <= bounding_y_prev_max; ++y) {
//            for (int x = bounding_x_prev_min; x <= bounding_x_prev_max; ++x) {
//                if (!world_if_block_passable(x, y, bounding_z)) {
//                    collision_info->z_collided = true;
//                    // TODO: break ? save ?
//                }
//            }
//        }
//    }
//    // TODO: bounce?
//    collision_info->pos_adjusted.z = collision_info->z_collided ? pos_prev.z : pos_new.z;
//
//    // return if collided
//    return collision_info->x_collided || collision_info->y_collided || collision_info->z_collided;
//}

//bool world_test_collision_grided(CollisionInfo* collision_info, const Vec3 pos_prev, const Vec3 dir) {
//    // TODO better collision
//    Vec3 target = vec3_add(pos_prev, dir);
//    return !world_if_block_passable(target.x, target.y, target.z);
//}
